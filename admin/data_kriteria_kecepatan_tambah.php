...
<?php
$sql    = "SELECT id_kecepatan FROM kriteriakecepatan";
              ...
              <form class="form" method="post">
                <div class="form-group">
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <input class="form-control" type="text" name="id_kecepatan" value="<?= $kodeoto ?>"
                      readonly="readonly">
                  </div>
                </div>
                <div class="form-group">
...
if (isset($_POST['simpan'])) {
  $id_kecepatan   = $_POST ['id_kecepatan'];
  $hash           = $_POST ['hash'];
  $fuzzy          = $_POST ['fuzzy'];
  $nilai          = $_POST ['nilai'];

  $query = "INSERT INTO kriteriakecepatan (id_kecepatan, kecepatan, bilanganfuzzy, nilai) VALUES ('$id_kecepatan','$hash','$fuzzy','$nilai')";
  $tambah = mysqli_query($konek, $query);
  if ($tambah === true) {
    echo "<script>alert('Kriteria Berhasil Di Tambah') </script>";
		echo "<script>window.location.href = \"kriteriaA.php\" </script>";
  }
  else {
