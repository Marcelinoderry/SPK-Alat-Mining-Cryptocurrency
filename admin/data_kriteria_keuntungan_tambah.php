...
<?php
$sql    = "SELECT id_keuntungan FROM kriteriakeuntungan";
        ...
        <div class="col-xl-12  col-lg-8">
          <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
              <h5 class="m-0 font-weight-bold text-info"> <b> Tambah Kriteria Keuntungan </b></h5>
            </div>
            <div class="card-body">
              <form class="form" method="post">
                <div class="form-group">
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <input class="form-control" type="text" name="id_keuntungan" value="<?= $kodeoto ?>"
                      readonly="readonly">
                  </div>
                </div>
                <div class="form-group">
...
if (isset($_POST['simpan'])) {
  $id_keuntungan   = $_POST ['id_keuntungan'];
  $profit          = $_POST ['profit'];
  $fuzzy           = $_POST ['fuzzy'];
  $nilai           = $_POST ['nilai'];

  $query = "INSERT INTO kriteriakeuntungan (id_keuntungan, keuntungan, bilanganfuzzy, nilai) VALUES ('$id_keuntungan','$profit','$fuzzy','$nilai')";
