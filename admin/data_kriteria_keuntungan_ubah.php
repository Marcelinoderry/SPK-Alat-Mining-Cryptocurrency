...
<?php
$iduntung  = $_GET['id_keuntungan'];
$sql       = "SELECT * FROM kriteriakeuntungan WHERE id_keuntungan = '$iduntung'";
              ...
              <form class="form" method="post">
                <div class="form-group">
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <input class="form-control" type="text" name="iduntung" value="<?php echo $row['id_keuntungan']; ?>"
                      readonly="readonly">
                  </div>
                </div>
                <div class="form-group">
...
if (isset($_POST['simpan'])) {
  ...
  $query = "UPDATE kriteriakeuntungan SET keuntungan = '$keuntungan', bilanganfuzzy = '$bilfuzzy', nilai = '$nilai' WHERE id_keuntungan = '$iduntung'";
